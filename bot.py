...
# ---------------------
def draw_centered_text(draw, center_x, center_y, text, font, fill="black"):
    bbox = draw.textbbox((0,0), text, font=font)
    text_w = bbox[2] - bbox[0]
    text_h = bbox[3] - bbox[1]
    cx = center_x - text_w/2
    cy = center_y - text_h/2
...
def generate_card(rewards, scratched):
    ...
    for i, scratched_box in enumerate(scratched):
        if scratched_box:
            ...
            draw_centered_text(draw, center_x, center_y, reward, font, fill="black")
