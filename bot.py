...
# COMMAND
# -------------------------
@bot.tree.command(name="givecard", description="Give a scratch card", guild=discord.Object(id=GUILD_ID))
...
async def on_ready():
    ...
    try:
        ...
        synced = await bot.tree.sync(guild=guild)  # ⚡ instant command
