...
SPRINKLE_WEIGHTS = [50,30,20]  # 5 Seasonal most common
...
SUGAR_WEIGHTS = [10]*6 + [5]*6 + [2]*13  # small numbers more likely

SWEET_POOL = ["Free","5%","10%","20%","25%","50%"]
SWEET_WEIGHTS = [50,30,10,5,3,2]

VANILLA_POOL = [f"{x} Sugar Bits" for x in range(100,50001,100)]
VANILLA_WEIGHTS = [500 if int(x.split()[0])<=1000 else 10 for x in VANILLA_POOL]  # small numbers more likely
