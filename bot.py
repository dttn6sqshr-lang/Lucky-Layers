...
def generate_rewards(card_type):
    ...
    for i in range(4):  # 4 hearts
        if card_type=="Vanilla":
            ...
            rewards.append(str(random.choices(CARD_PRIZES[card_type]+["Nothing"], weights=[1]*len(CARD_PRIZES[card_type])+[4], k=1)[0]))
    return rewards
