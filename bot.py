...
# Convert all IDs from strings to integers
...
def check_staff(member, spin_type):
    """Check if member has a role allowed for this spin type."""
...
def generate_card(rewards, scratched):
    ...
    img = Image.open("scratch_template.png")  # updated path
