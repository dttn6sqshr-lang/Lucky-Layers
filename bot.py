...
# Card generation
# ---------------------
def draw_centered_text(draw, center_x, center_y, text, font, fill="black", x_offset=15, y_offset=0):
        ...
        if scratched_box:
            ...
            if reward == "10k":
                for offset in range(1,4):
                    draw_centered_text(draw, center_x-offset, center_y, reward, font, fill=(255,215,0), x_offset=15)
                    draw_centered_text(draw, center_x+offset, center_y, reward, font, fill=(255,215,0), x_offset=15)
                    draw_centered_text(draw, center_x, center_y-offset, reward, font, fill=(255,215,0), x_offset=15)
                    draw_centered_text(draw, center_x, center_y+offset, reward, font, fill=(255,215,0), x_offset=15)

            # Draw the main prize text with offset
            draw_centered_text(draw, center_x, center_y, reward, font, fill="black", x_offset=15)
